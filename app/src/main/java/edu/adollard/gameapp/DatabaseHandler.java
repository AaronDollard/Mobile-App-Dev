...
import java.util.List;
    ...
    public class DatabaseHandler extends SQLiteOpenHelper {
        ...
        private static final String DATABASE_NAME = "GameAppDB";
        ...
        void addHiScore(HighScoreClass hiScore) {
            SQLiteDatabase db = this.getWritableDatabase();
        ...
        HighScoreClass getHiScore(int id) {
            ...
            HighScoreClass hiScore = new HighScoreClass(Integer.parseInt(
                    cursor.getString(0)),
                    cursor.getString(1),
                    cursor.getString(2),
                    cursor.getInt(3));
        ...
        public List<HighScoreClass> getAllHiScores() {
            List<HighScoreClass> hiScoreList = new ArrayList<HighScoreClass>();
            // Select All Query
            ...
            if (cursor.moveToFirst()) {
                do {
                    HighScoreClass hiScore = new HighScoreClass();
        ...
        public int updateHiScore(HighScoreClass hiScore) {
            SQLiteDatabase db = this.getWritableDatabase();
        ...
        public void deleteHiScore(HighScoreClass hiScore) {
            SQLiteDatabase db = this.getWritableDatabase();
        ...
        public List<HighScoreClass> getTopFiveScores() {
            List<HighScoreClass> hiScoreList = new ArrayList<HighScoreClass>();
            // Select All Query
            String selectQuery = "SELECT  * FROM " + TABLE_HI_SCORES +
                    " ORDER BY SCORE DESC " +
